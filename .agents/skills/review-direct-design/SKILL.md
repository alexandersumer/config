...
Review the design directly in this session. Do not invoke subagents. Preserve the same quality bar as `review-delegated-design` by grounding the review in the artifact, diff, code context, conventions, and concrete future change paths.
