...
Review the code directly in this session. Do not invoke subagents. Preserve the same quality bar as `review-delegated-branch` by doing explicit, sequential review passes and validating every finding against concrete code, behavior, or conventions.
