...
Fix Correct comments. If any Unclear comments remain after reading context, ask one clarifying question and leave them unmodified until answered. Ignore Subjective, Wrong, and YAGNI comments unless the user explicitly chooses them.
...
- `<file>:<line> [needs clarification: <question>]`
