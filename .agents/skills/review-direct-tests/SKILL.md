...
description: Use when reviewing, strengthening, or adding tests for a pull request, branch, diff, bug fix, feature, or changed behavior directly without subagents.
register_cmd: true
---
